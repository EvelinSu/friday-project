...
const slice = createSlice({
    ...
    reducers: {
        ...
        setPacks(state, action: PayloadAction<{ totalCount: number, packs: TPack[] }>) {
...
export const getPacks =
    (page: number, pageCount: number, userId?: string) => (dispatch: TAppDispatch) => {
        setIsFetching(true)
        ...
        packsAPI.getPacks(page, pageCount)
                .then((res) => {
                    ...
                    console.log(res)
                    dispatch(setPacks({totalCount: cardPacksTotalCount, packs: cardPacks}))
                })
                .catch((e) => {
